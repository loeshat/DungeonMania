...
public class Game {
    ...
    public Game build(String buildable) throws InvalidActionException {
        ...
        if (buildable.equals("midnight_armour")) {
            ...
            int numberOfZombies = zombie.size();
            if (numberOfZombies != 0) {
                throw new InvalidActionException("zombies in the dungeon, cannot build");
            }
        }
    ...
    public int getInitialTreasureCount() {
        return initialTreasureCount + initialSunstoneCount;
    }
