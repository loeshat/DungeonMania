...
public class EntityFactory {
    ...
    public Sceptre buildSceptre() {
        ...
        int sceptreDurability = 1;
        return new Sceptre(mindControlDuration, sceptreDurability);
    }

    public MidnightArmour buildMidnightArmour() {
        int attackBoost = config.optInt("midnight_armour_attack");
        int defenceBoost = config.optInt("midnight_armour_defence");
        return new MidnightArmour(attackBoost, defenceBoost);
    }
